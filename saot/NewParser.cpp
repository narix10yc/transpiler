...
std::string saot::parse::getNameOfTokenKind(TokenKind kind) {
    switch (kind) {
        ...
        case tk_LineFeed: return "\\n";
        case tk_Numeric: return "Num";
        case tk_Identifier: return "Identifier";

        case tk_L_RoundBraket: return "(";
        case tk_R_RoundBraket: return ")";
        case tk_L_CurlyBraket: return "{";
        case tk_R_CurlyBraket: return "}";
...
void Parser::printLocation(std::ostream& os) const {
    ...
    os << "      | "
       ...
       << GREEN_FG << BOLD
       << std::string(static_cast<size_t>(curToken.memRefEnd - curToken.memRefBegin), '^')
       << "\n" << RESET;
}
...
std::ostream& Token::print(std::ostream& os) const {
    ...
    switch (kind) {
        ...
        case tk_Eof: os << "EoF"; break;
        case tk_LineFeed: os << "\\n"; break;

        case tk_L_RoundBraket: os << "("; break;
        case tk_R_RoundBraket: os << ")"; break;
        case tk_L_SquareBraket: os << "["; break;
        case tk_R_SquareBraket: os << "]"; break;
        case tk_L_CurlyBraket: os << "{"; break;
        case tk_R_CurlyBraket: os << "}"; break;
        case tk_Less: os << "<"; break;
        case tk_Greater: os << ">"; break;

        case tk_Comma: os << ","; break;
        case tk_Semicolon: os << ";"; break;
        case tk_Percent: os << "%"; break;
        case tk_AtSymbol: os << "@"; break;
    
        default: os << static_cast<int>(kind) << " Not Imp'ed"; break;
    }
...
void Lexer::lex(Token& tok) {
    ...
    switch (c) {
    case '\0': assignTok(tk_Eof); return;
    case '\n': {
    ...
    case '(': assignTok(tk_L_RoundBraket); return;
    case ')': assignTok(tk_R_RoundBraket); return;
    case '[': assignTok(tk_L_SquareBraket); return;
    case ']': assignTok(tk_R_SquareBraket); return;
    case '{': assignTok(tk_L_CurlyBraket); return;
    case '}': assignTok(tk_R_CurlyBraket); return;
    case '<': assignTok(tk_Less); return;
    case '>': assignTok(tk_Greater); return;
    
    case ',': assignTok(tk_Comma); return;
    case ';': assignTok(tk_Semicolon); return;
    case '%': assignTok(tk_Percent); return;
    case '@': assignTok(tk_AtSymbol); return;
...
Lexer::line_info_t Lexer::getCurLineInfo() const {
    ...
    return line_info_t{ .line = line,
                        .memRefBegin = lineBegin,
                        .memRefEnd = lineEnd };
}
