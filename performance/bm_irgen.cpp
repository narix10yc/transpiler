...
extern "C" {
    void SEP_KERNEL(real_t*, real_t*, uint64_t, uint64_t, void*);
    // void ALT_KERNEL(real_t*, uint64_t, uint64_t, void*);
}
...
int main() {
    Timer timer;
    TimingResult tr;
    real_t *real, *imag, *data;
    uint64_t nqubits;

    real_t m[8] = {0.7455743899704769,-0.6611393443073451,0.5681414468755827,0.6795542237022189,0,0.08374721744037222,0.3483304829644841,0.3067364145782554};
    ...
    //     nqubits = _nqubits;
    //     return [&]() {
    //         data = (real_t*) aligned_alloc(64, 2 * sizeof(real_t) * (1<<nqubits));
    //     };
    // };
