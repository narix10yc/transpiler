...
define void @f32_s2_sep_u2q_k4l3(ptr %preal, ptr %pimag, i64 %idx_start, i64 %idx_end, ptr %pmat) {
entry:
...
loopBody:                                         ; preds = %loop
  ...
  %newRe0_1 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe1, <4 x float> %Re1, <4 x float> %newRe0_)
  %newRe0_2 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe2, <4 x float> %Re2, <4 x float> %newRe0_1)
  %newRe0_3 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe3, <4 x float> %Re3, <4 x float> %newRe0_2)
  %newRe0_4 = fmul <4 x float> %mIm0, %Im0
  %newRe0_5 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm1, <4 x float> %Im1, <4 x float> %newRe0_4)
  %newRe0_6 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm2, <4 x float> %Im2, <4 x float> %newRe0_5)
  %newRe0_7 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm3, <4 x float> %Im3, <4 x float> %newRe0_6)
  %newRe0 = fsub <4 x float> %newRe0_3, %newRe0_7
  %newRe1_ = fmul <4 x float> %mRe4, %Re0
  %newRe1_8 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe5, <4 x float> %Re1, <4 x float> %newRe1_)
  %newRe1_9 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe6, <4 x float> %Re2, <4 x float> %newRe1_8)
  %newRe1_10 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe7, <4 x float> %Re3, <4 x float> %newRe1_9)
  %newRe1_11 = fmul <4 x float> %mIm4, %Im0
  %newRe1_12 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm5, <4 x float> %Im1, <4 x float> %newRe1_11)
  %newRe1_13 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm6, <4 x float> %Im2, <4 x float> %newRe1_12)
  %newRe1_14 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm7, <4 x float> %Im3, <4 x float> %newRe1_13)
  %newRe1 = fsub <4 x float> %newRe1_10, %newRe1_14
  %newRe2_ = fmul <4 x float> %mRe8, %Re0
  %newRe2_15 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe9, <4 x float> %Re1, <4 x float> %newRe2_)
  %newRe2_16 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe10, <4 x float> %Re2, <4 x float> %newRe2_15)
  %newRe2_17 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe11, <4 x float> %Re3, <4 x float> %newRe2_16)
  %newRe2_18 = fmul <4 x float> %mIm8, %Im0
  %newRe2_19 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm9, <4 x float> %Im1, <4 x float> %newRe2_18)
  %newRe2_20 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm10, <4 x float> %Im2, <4 x float> %newRe2_19)
  %newRe2_21 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm11, <4 x float> %Im3, <4 x float> %newRe2_20)
  %newRe2 = fsub <4 x float> %newRe2_17, %newRe2_21
  %newRe3_ = fmul <4 x float> %mRe12, %Re0
  %newRe3_22 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe13, <4 x float> %Re1, <4 x float> %newRe3_)
  %newRe3_23 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe14, <4 x float> %Re2, <4 x float> %newRe3_22)
  %newRe3_24 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe15, <4 x float> %Re3, <4 x float> %newRe3_23)
  %newRe3_25 = fmul <4 x float> %mIm12, %Im0
  %newRe3_26 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm13, <4 x float> %Im1, <4 x float> %newRe3_25)
  %newRe3_27 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm14, <4 x float> %Im2, <4 x float> %newRe3_26)
  %newRe3_28 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm15, <4 x float> %Im3, <4 x float> %newRe3_27)
  %newRe3 = fsub <4 x float> %newRe3_24, %newRe3_28
  %newIm0_ = fmul <4 x float> %mRe0, %Im0
  %newIm0_29 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe1, <4 x float> %Im1, <4 x float> %newIm0_)
  %newIm0_30 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe2, <4 x float> %Im2, <4 x float> %newIm0_29)
  %newIm0_31 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe3, <4 x float> %Im3, <4 x float> %newIm0_30)
  %newIm0_32 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm0, <4 x float> %Re0, <4 x float> %newIm0_31)
  %newIm0_33 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm1, <4 x float> %Re1, <4 x float> %newIm0_32)
  %newIm0_34 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm2, <4 x float> %Re2, <4 x float> %newIm0_33)
  %newIm0_35 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm3, <4 x float> %Re3, <4 x float> %newIm0_34)
  %newIm1_ = fmul <4 x float> %mRe4, %Im0
  %newIm1_36 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe5, <4 x float> %Im1, <4 x float> %newIm1_)
  %newIm1_37 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe6, <4 x float> %Im2, <4 x float> %newIm1_36)
  %newIm1_38 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe7, <4 x float> %Im3, <4 x float> %newIm1_37)
  %newIm1_39 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm4, <4 x float> %Re0, <4 x float> %newIm1_38)
  %newIm1_40 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm5, <4 x float> %Re1, <4 x float> %newIm1_39)
  %newIm1_41 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm6, <4 x float> %Re2, <4 x float> %newIm1_40)
  %newIm1_42 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm7, <4 x float> %Re3, <4 x float> %newIm1_41)
  %newIm2_ = fmul <4 x float> %mRe8, %Im0
  %newIm2_43 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe9, <4 x float> %Im1, <4 x float> %newIm2_)
  %newIm2_44 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe10, <4 x float> %Im2, <4 x float> %newIm2_43)
  %newIm2_45 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe11, <4 x float> %Im3, <4 x float> %newIm2_44)
  %newIm2_46 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm8, <4 x float> %Re0, <4 x float> %newIm2_45)
  %newIm2_47 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm9, <4 x float> %Re1, <4 x float> %newIm2_46)
  %newIm2_48 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm10, <4 x float> %Re2, <4 x float> %newIm2_47)
  %newIm2_49 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm11, <4 x float> %Re3, <4 x float> %newIm2_48)
  %newIm3_ = fmul <4 x float> %mRe12, %Im0
  %newIm3_50 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe13, <4 x float> %Im1, <4 x float> %newIm3_)
  %newIm3_51 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe14, <4 x float> %Im2, <4 x float> %newIm3_50)
  %newIm3_52 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mRe15, <4 x float> %Im3, <4 x float> %newIm3_51)
  %newIm3_53 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm12, <4 x float> %Re0, <4 x float> %newIm3_52)
  %newIm3_54 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm13, <4 x float> %Re1, <4 x float> %newIm3_53)
  %newIm3_55 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm14, <4 x float> %Re2, <4 x float> %newIm3_54)
  %newIm3_56 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %mIm15, <4 x float> %Re3, <4 x float> %newIm3_55)
