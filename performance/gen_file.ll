...
loopBody:                                         ; preds = %loop
  %idx_and_outer = and i64 %idx, -4611686018427387904
  %shl_outer = shl i64 %idx_and_outer, 3
  %idx_and_inner = and i64 %idx, 4611686018427387903
  %shl_inner = shl i64 %idx_and_inner, 2
  %alpha = add i64 %shl_outer, %shl_inner
  %beta = add i64 %alpha, 1
...
loopBody:                                         ; preds = %loop
  %idx_and_outer = and i64 %idx, -9223372036854775808
  %shl_outer = shl i64 %idx_and_outer, 3
  %idx_and_inner = and i64 %idx, 9223372036854775807
  %shl_inner = shl i64 %idx_and_inner, 2
  %alpha = add i64 %shl_outer, %shl_inner
